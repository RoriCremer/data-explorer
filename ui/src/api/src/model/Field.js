...
export default class Field {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty("display_text")) {
        obj["display_text"] = ApiClient.convertToType(
          data["display_text"],
          "String"
        );
      }
      ...
      if (data.hasOwnProperty("is_facet_value")) {
        obj["is_facet_value"] = ApiClient.convertToType(
          data["is_facet_value"],
          "Boolean"
        );
      }
  ...
  /**
   * If this is a facet or a facet value field.
   * @member {Boolean} is_facet_value
   */
  is_facet_value = undefined;
}
